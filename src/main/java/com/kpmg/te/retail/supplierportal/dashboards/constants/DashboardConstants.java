package com.kpmg.te.retail.supplierportal.dashboards.constants;
...
public class DashboardConstants {
	...
	//public static final String countQuery = "SELECT COUNT(*) AS COUNT_NUMBER FROM genericfiltereddatatable";
